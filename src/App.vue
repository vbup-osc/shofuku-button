        ...
        <footer class="footer">
            <div class="container-fluid footer-content">
                <button class="btn-buttom btn-buttom-info">
                    <a href="javascript:location.reload();" style="color: #eeeeee;text-decoration: none">Wine Glass 1.0.0 BETA</a>
                </button>
                <div class="pull-left">
                    <div class="text-left" style="color: #5231a7;">{{$t("info.author")}}</div>
                    <div class="text-left">{{$t("info.notOfficial")}}</div>
                    <div class="text-left"><a href="https://github.com/vbup-osc/shofuku-button" target="_blank">{{$t("info.audioStaff")}}</a></div>
                    <div class="text-left"><a href="https://github.com/vbup-osc/shofuku-button/issues" target="_blank">{{$t("info.toGithub")}}</a></div>
                </div>
            </div>
        </footer>
  </div>
